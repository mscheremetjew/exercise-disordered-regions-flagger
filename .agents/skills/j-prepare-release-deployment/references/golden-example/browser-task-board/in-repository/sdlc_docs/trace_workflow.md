...
|---|---|---|---|---|---|---|
| User story validation | Initial Release | Complete | BDD User Story Completion Validation | selected stories validated with `tests/validation` | None | Run h-create-implementation-pull-request |
